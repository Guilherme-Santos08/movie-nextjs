...
export default function SideBar() {
  ...
  const openBar = () => setToogleBar(!toogleBar);
  ...
  return (
    <Container>
      <nav>
        ...
        <ul className={`${toogleBar ? "visible" : ""}`}>
          <button className="btn-mobile" onClick={openBar}>
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fas"
        ...
        <button className="btn-mobile menu-mobile" onClick={openBar}>
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fas"
